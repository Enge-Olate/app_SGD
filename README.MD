...
## Descrição
O App SGD é um projeto em Python desenvolvido para gerenciar e organizar dados de forma eficiente. Este aplicativo oferece funcionalidades para armazenamento, consulta e manipulação de dados.
